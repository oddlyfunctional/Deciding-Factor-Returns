...
public class MainFrame extends javax.swing.JFrame {
    ...
    public void menu() {
        showingNodes.clear();
        changePanel(new InitialMenuComponent());
    }
    ...
    private void viewHipotesis() {
        if (showingNodes.empty()) {
            ...
            changePanel(new ViewHipotesisComponent(showingNodes.peek()));
        }
    }
    ...
    public void startEditing() {
        changePanel(new EditNodeComponent(showingNodes.peek()));
    }

    public void startEditing(Node node, Node parent) {
        changePanel(new EditNodeComponent(node, parent));
    }

    public float consultNode(Node node) {
        EntryNodeValueComponent entry = new EntryNodeValueComponent(this, true, node);
        entry.setLocation(this.getLocation());
        entry.setVisible(true);
        return entry.getValue();
    }

    public void showResults(List<Node> nodes, Policy policy, ResultsComponent previousLevel) throws PolicyException {
        changePanel(new ResultsComponent(nodes, policy, previousLevel));
    }

    public void showPreviousResults() {
        changePanel(((ResultsComponent) activePanel).getPreviousLevel());
    }

    public void showWarning(String msg) {
        JOptionPane.showConfirmDialog(this, msg, I18n.t("warning"), JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE);
    }
