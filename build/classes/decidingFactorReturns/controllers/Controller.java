...
import decidingFactorReturns.GUI.MainFrame;
...
public class Controller {
    ...
    public float requireValueInput(Node node){
        return MainFrame.getInstance().consultNode(node);
    }

    public void showWarning(String msg){
        MainFrame.getInstance().showWarning(msg);
    }
