...
public class Node {
    ...
    public Float getValue() throws PolicyException {
        if (value == null) {
            if (isHipotesis()) {
                ...
                value = Controller.getInstance().requireValueInput(this);
            }
        }
        return value;
    }
    ...
    public boolean isValid() throws PolicyException {
    ...
    public Float getWeightedValue() throws PolicyException {
        return getValue() < 0 ? value * negativeWeight : value * positiveWeight;
    }

    public Float getValueInPercentage() throws PolicyException {
        return getWeightedValue() / (getMaxValue() - getMinValue());
    }
