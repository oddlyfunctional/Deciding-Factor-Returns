...
public class EditNodeComponent extends javax.swing.JPanel {

    private Node node;
    private Node parent;
    private boolean newNode;

    /** Creates new form EditNodeComponent */
    public EditNodeComponent(Node parent) {
        this.parent = parent;
        initComponents();
        if (parent == null) {
            node = Controller.getInstance().getRoot();
    ...
    public EditNodeComponent(Node node, Node parent) {
        initComponents();
        this.node = node;
        this.parent = parent;
