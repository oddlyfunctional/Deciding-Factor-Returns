...
public class ViewHipotesisComponent extends javax.swing.JPanel {

    private Node hipotesis;

    /** Creates new form ViewHipotesisComponent */
    public ViewHipotesisComponent(Node hipotesis) {
    ...
    private void removeChildButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeChildButtonActionPerformed
        ...
        if (childIndex != -1) {
            Controller.getInstance().removeNode(hipotesis.getChildren().remove(childIndex));
    ...
    private void saveTreeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveTreeButtonActionPerformed
        ...
        if (fc.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
            try {
                Controller.getInstance().saveTree(fc.getSelectedFile());
