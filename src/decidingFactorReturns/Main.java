...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Node root = Edit.getInstance().getRoot();
        root.setName("Raíz");
        ...
        Edit.getInstance().addNode(grandson);

        try {
            Edit.getInstance().saveTree(new File("teste"));
            Edit.getInstance().newTree();
            Edit.getInstance().loadTree(new File("teste"));
            for (Node n : Edit.getInstance().getNodes()) {
                System.out.println("!!!!!!!!!!!");
